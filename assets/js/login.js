/* ============================================================================
   login.js — LOGICA DELLA SCHERMATA DI BLOCCO (index.php)
   ----------------------------------------------------------------------------
   Orologio live, preloader sugli asset locali, invio del form a login.php
   (contratto backend invariato) e, in caso di ?demo=1, il widget "dietro le
   quinte" che mostra i passaggi del backend.

   Modifiche rispetto alla versione inline:
   - lo sfondo è ora un semplice elemento (stesso sfondo del desktop), niente
     <video>: il preloader non aspetta più un file video pesante;
   - lo sblocco è più rapido (480 ms) e continuo verso il desktop.
   ========================================================================== */
...
/* Durata dello sblocco prima di passare al desktop (più rapida di prima). */
const UNLOCK_MS = 480;
...
/* ============================================================================
   PRELOADER — la barra si completa sugli asset locali (font + immagini).
   Sblocco garantito entro 5s anche se qualcosa non si carica.
   ========================================================================== */
(function preload() {
  ...
  /* Avanzamento della barra a ogni asset pronto. */
  ...
  /* Rete di sicurezza: il sito si sblocca comunque entro 5s. */
  setTimeout(completa, 5000);
})();

/* ============================================================================
   DEMO (?demo=1) — visualizzazione schematica dei passaggi del backend
   ========================================================================== */
...
/* Determina quale tratto dello schema (client→server→db) evidenziare. */
function zonaDi(p) {
