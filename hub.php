    ...
    <aside class="mw-side" aria-label="Indicazioni del percorso">
      ...
      <div class="mw-routecard" aria-label="Durata del percorso">
        <div class="mw-rc-main">
          ...
          <div class="mw-rc-icons" aria-label="Sintesi delle tappe">
            <span><svg viewBox="0 0 24 24"><path d="M12 3 3 8l9 5 9-5-9-5Zm-5 8.2v3.5c0 1.7 2.2 3.3 5 3.3s5-1.6 5-3.3v-3.5l-5 2.8-5-2.8Z"/></svg><b>Diploma</b><small>2026</small></span>
            <span><svg viewBox="0 0 24 24"><path d="M4 19h16v2H4v-2Zm1-9 7-5 7 5v8h-4v-5H9v5H5v-8Zm7 1.2a1.7 1.7 0 1 0 0-3.4 1.7 1.7 0 0 0 0 3.4Z"/></svg><b>Università</b><small>3 anni</small></span>
            <span><svg viewBox="0 0 24 24"><path d="M12 2.8c-4.2 0-7.6 3.4-7.6 7.6 0 5.7 7.6 10.8 7.6 10.8s7.6-5.1 7.6-10.8c0-4.2-3.4-7.6-7.6-7.6Zm0 10.4a2.8 2.8 0 1 1 0-5.6 2.8 2.8 0 0 1 0 5.6Z"/></svg><b>Estero</b><small>2031</small></span>
          </div>
          <em>Scala temporale reale</em>
        </div>
    ...
    <main class="mw-map-wrap" data-maps-stage aria-label="Mappa del percorso — tocca per proseguire">
      <svg class="maps-map mw-map" viewBox="0 0 1200 760" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Percorso di vita">
        ...
        <g id="maps-cam">
          ...
          <path id="maps-route-base" d="M145 650 C168 640 188 632 210 624 C238 612 262 602 286 588 C420 520 540 476 650 392 C722 337 760 314 795 286 C895 206 976 166 1042 132" fill="none" stroke="#0a4da8" stroke-width="16" stroke-linecap="round" stroke-linejoin="round" opacity=".5"/>
          <path id="maps-route" d="M145 650 C168 640 188 632 210 624 C238 612 262 602 286 588 C420 520 540 476 650 392 C722 337 760 314 795 286 C895 206 976 166 1042 132" fill="none" stroke="#0a84ff" stroke-width="11" stroke-linecap="round" stroke-linejoin="round"/>
          <path id="maps-route-progress" pathLength="1" d="M145 650 C168 640 188 632 210 624 C238 612 262 602 286 588 C420 520 540 476 650 392 C722 337 760 314 795 286 C895 206 976 166 1042 132" fill="none" stroke="#7cc4ff" stroke-width="11" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="1" stroke-dashoffset="1"/>

          <g class="mw-pin is-stop" data-step-pin="0" transform="translate(145 650)"><g class="mw-pin-drop" style="animation-delay:0.00s"><g class="mw-pin-rot"><circle class="pin-halo" cx="0" cy="-24" r="18"/><ellipse class="pin-ground" cx="0" cy="2" rx="9" ry="3"/><path class="pin-stem" d="M0 2 C-4 -7 -13 -11 -13 -23 A13 13 0 1 1 13 -23 C13 -11 4 -7 0 2 Z"/><circle class="pin-face" cx="0" cy="-23" r="11.5"/><circle class="pin-dot" cx="0" cy="-23" r="3.2"/><g class="mw-caption"><text x="0" y="19" text-anchor="middle">Cerebotani</text></g></g></g></g><g class="mw-pin is-stop" data-step-pin="1" transform="translate(210 624)"><g class="mw-pin-drop" style="animation-delay:0.07s"><g class="mw-pin-rot"><circle class="pin-halo" cx="0" cy="-24" r="18"/><ellipse class="pin-ground" cx="0" cy="2" rx="9" ry="3"/><path class="pin-stem" d="M0 2 C-4 -7 -13 -11 -13 -23 A13 13 0 1 1 13 -23 C13 -11 4 -7 0 2 Z"/><circle class="pin-face" cx="0" cy="-23" r="11.5"/><circle class="pin-dot" cx="0" cy="-23" r="3.2"/><g class="mw-caption"><text x="0" y="19" text-anchor="middle">FSL · PCTO</text></g></g></g></g><g class="mw-pin is-stop" data-step-pin="2" transform="translate(286 588)"><g class="mw-pin-drop" style="animation-delay:0.13s"><g class="mw-pin-rot"><circle class="pin-halo" cx="0" cy="-24" r="18"/><ellipse class="pin-ground" cx="0" cy="2" rx="9" ry="3"/><path class="pin-stem" d="M0 2 C-4 -7 -13 -11 -13 -23 A13 13 0 1 1 13 -23 C13 -11 4 -7 0 2 Z"/><circle class="pin-face" cx="0" cy="-23" r="11.5"/><circle class="pin-dot" cx="0" cy="-23" r="3.2"/><g class="mw-caption"><text x="0" y="19" text-anchor="middle">Diploma</text></g></g></g></g><g class="mw-pin is-stop" data-step-pin="3" transform="translate(795 286)"><g class="mw-pin-drop" style="animation-delay:0.20s"><g class="mw-pin-rot"><circle class="pin-halo" cx="0" cy="-24" r="18"/><ellipse class="pin-ground" cx="0" cy="2" rx="9" ry="3"/><path class="pin-stem" d="M0 2 C-4 -7 -13 -11 -13 -23 A13 13 0 1 1 13 -23 C13 -11 4 -7 0 2 Z"/><circle class="pin-face" cx="0" cy="-23" r="11.5"/><circle class="pin-dot" cx="0" cy="-23" r="3.2"/><g class="mw-caption"><text x="0" y="19" text-anchor="middle">Università</text></g></g></g></g><g class="mw-pin is-dest" data-step-pin="4" transform="translate(1042 132)"><g class="mw-pin-drop" style="animation-delay:0.26s"><g class="mw-pin-rot"><circle class="pin-halo" cx="0" cy="-24" r="18"/><ellipse class="pin-ground" cx="0" cy="3" rx="16" ry="5"/><path class="pin-stem" d="M0 3 C-6 -8 -20 -13 -20 -31 A20 20 0 1 1 20 -31 C20 -13 6 -8 0 3 Z"/><circle class="pin-face" cx="0" cy="-31" r="18"/><circle class="pin-dot pin-dot-dest" cx="0" cy="-31" r="4.4"/><g class="mw-caption"><text x="0" y="19" text-anchor="middle">America</text></g></g></g></g>
