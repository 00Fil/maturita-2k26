/* ============================================================
   hub.js — finestre, dock e orologio del desktop
...
wins.forEach(w => {
  ...
  /* semafori macOS: generati qui per non ripeterli nell'HTML */
  ...
  bar.addEventListener('pointermove', (e) => {
    ...
    const ny = Math.min(Math.max(oy + e.clientY - sy, 36), window.innerHeight - 60);
    w.style.left = nx + 'px';
    w.style.top = ny + 'px';
  });
...
/* card, voci di menu e icone del desktop aprono le finestre */
